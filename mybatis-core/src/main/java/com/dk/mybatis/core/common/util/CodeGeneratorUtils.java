package com.dk.mybatis.core.common.util;
...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/tp_music?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath","com.dk.mybatis");
                this.setMap(map);
            }
        };
        ...
        focList.add(new FileOutConfig("/templates/add-or-update.vue.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/src/main/resources/static/views/" + pc.getModuleName()
        ...
        strategy.setSuperControllerClass("com.dk.mybatis.core.common.base.AbstractController");
